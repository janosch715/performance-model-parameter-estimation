...
public class ResourceUtilizationEstimation {
	...
	public ResourceUtilizationEstimation(Set<String> ignoredInternalActionIds, Repository pcmRepository,
	...
	private void estimateAllResourceDemands() {
		for (ServiceCall serviceCall : this.serviceCallRepository.getServiceCalls()) {
			...
			if (rdsForTime == null) {
				rdsForTime = new ArrayList<ResourceUtilizationEstimation.ServiceCallRdEstimation>();
